...
class BottomViewBehavior(context: Context, attrs: AttributeSet) :
    ...
    override fun onMeasureChild(
        ...
        if (topLayoutBehavior != null) {
            ...
            val childHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(
                parent.height - topLayoutBehavior.bottom,
                View.MeasureSpec.EXACTLY
            )
    ...
    override fun onLayoutChild(
        ...
        val topLayoutBehavior = this.topLayoutBehavior
        val left = 0
        val top = topLayoutBehavior?.bottom ?: 0
    ...
    companion object {
        private const val TAG = "BottomViewBehavior"
